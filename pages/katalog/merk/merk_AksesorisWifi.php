...
$query = "SELECT * FROM produk WHERE merk_produk = 'wifi' AND kategori_id = '4'";
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                    <div class="card mx-auto">
                        <div class="card-body">
                            ...
                            <hr>
                            <a href="https://wa.me/+6282115118515?text=Halo,%20saya%20ingin%20order%20wifi!" class="btn btn-dark btn-outline-success">Pesan Sekarang !</a>
                        </div>
                    </div>  
                </div>
                <?php
