...
<head>
    ...
    <title>Kabel dan Konektor - Sehati Computer</title>
            ...
            <div id="content">
                ...
                <nav class="navbar sticky-top navbar-expand bg-dark topbar mb-4 static-top shadow">
                    ...
                    <div class="navbar-text text-start">
                        <h1 class="h4 my-auto mx-auto text-warning">Katalog - Kabel & Konektor</h1>    
                    </div>
                        ...
                        <div class="col-sm-6 mx-auto">
                            <div class="card shadow mb-4">
                                <div class="card-header bg-dark py-3 text-center">
                                    <div class="row">
                                        <div class="col-6">
                                            <h6 class="mt-3 ml-3 font-weight-normal text-warning">Daftar tipe Kabel & Konektor</h6>
                                        </div>
                                        <div class="col-6">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="m-0">
                                        <p class="text-dark text-center">
                                            Silahkan Pilih berdasarkan tipe yang anda inginkan
                                        </p>
                                    </div>
                                    ...
                                    <div class="m-0">
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <div class="col-6">
                                                    <ul>
                                                    <li><a href="kategori_kabel.php?p=merk_KabelUsb" class="btn btn-sm btn-dark mb-2">Kabel USB</a></li>
                                                    <li><a href="kategori_kabel.php?p=merk_KabelPrinter" class="btn btn-sm btn-dark mb-2">Kabel Printer</a></li>
                                                    <li><a href="kategori_kabel.php?p=merk_KabelCharger" class="btn btn-sm btn-dark mb-2">Charger</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
